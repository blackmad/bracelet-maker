...
export class InnerDesignCirclesXVera implements ModelMaker {
    ...
    return [
        ...
        new RangeMetaParameter({ title: "Center X Noise Demon 1", min: 1, max: 400, value: 20, step: 1, name: 'centerXNoiseDenom1' }),
        new RangeMetaParameter({ title: "Center X Noise Demon 2", min: 1, max: 400, value: 20, step: 1, name: 'centerXNoiseDenom2' }),
        new RangeMetaParameter({ title: "Center Y Noise Demon 1", min: 1, max: 400, value: 20, step: 1, name: 'centerYNoiseDenom1' }),
        new RangeMetaParameter({ title: "Center Y Noise Demon 2", min: 1, max: 400, value: 10, step: 1, name: 'centerYNoiseDenom2' }),
        new RangeMetaParameter({ title: "Y Offset", min: 0.1, max: 3.0, value: 0.5, step: 0.01, name: 'yOffset' }),
        new RangeMetaParameter({ title: "Row Offset", min: 0.0, max: 1.0, value: 0.2, step: 0.01, name: 'rowOffset' }),
    ]
  }

  public make(params: Map<string, any>): MakerJs.IModel {
    return new InnerDesignCirclesXVeraImpl(params);
  }
}