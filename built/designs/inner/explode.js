...
export class InnerDesignExplode extends AbstractExpandInnerDesign {
    makePaths(paper, params) {
        ...
        let centers = _.times(numCenters, i => new paper.Point(boundaryRect.x + (boundaryRect.width * ((i + 1) / (numCenters + 1))), boundaryRect.y + (boundaryRect.height * ((i + 1) / (numCenters + 1)))));
        // if (numCenters == 1) {
        //   centers = [
        //     [
        //       boundaryRect.center
