...
export class FastAbstractInnerDesign {
    constructor() {
        this.needSubtraction = true;
        this.allowOutline = false;
        this.smoothOutline = true;
        this.requiresSafeConeClamp = true;
        this.forceContainmentDefault = true;
        this.needSeed = true;
        this.controlInfo = '';
    }
    get metaParameters() {
    ...
    make(paper, params) {
        ...
        if (this.allowOutline && shouldMakeOutline) {
            ...
            paths = paths.filter((m) => params.outerModel.contains(m.bounds) ||
            ...
            if (design.outlinePaths) {
                ...
                if (!hasCurves) {
                    ...
                    outline = paper.Path.prototype.offset.call(outline, params.outlineSize, { cap: 'miter' });
                    //  outline = outline.children[0];
                    //  outline.closePath();
                }
                else {
                    paths.map((p) => {
                        const exploded = paper.Path.prototype.offset.call(p, params.outlineSize, { cap: 'miter' });
...
//# sourceMappingURL=fast-abstract-inner-design.js.map