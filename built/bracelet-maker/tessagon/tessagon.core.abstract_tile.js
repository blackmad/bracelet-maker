...
import { ValueError, __class__, __get__, __in__, __kwargtrans__, __mod__, dict, isinstance, len, list, print, tuple } from './org.transcrypt.__runtime__.js';
...
export var AbstractTile = __class__('AbstractTile', [ValueBlend], {
    ...
    get get_neighbor_tile() {
        return __get__(this, function (self, neighbor_keys) {
            if (arguments.length) {
                var __ilastarg0__ = arguments.length - 1;
                if (arguments[__ilastarg0__] && arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")) {
                    var __allkwargs0__ = arguments[__ilastarg0__--];
    ...
    get _get_nested_list_value() {
        return __get__(this, function (self, nested_list, index_keys) {
            if (arguments.length) {
                var __ilastarg0__ = arguments.length - 1;
                if (arguments[__ilastarg0__] && arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")) {
                    var __allkwargs0__ = arguments[__ilastarg0__--];
                    for (var __attrib0__ in __allkwargs0__) {
                        switch (__attrib0__) {
                            case 'self':
                                ...
                                break;
                            case 'nested_list':
                                var nested_list = __allkwargs0__[__attrib0__];
                                break;
                            case 'index_keys':
    ...
    get _set_nested_list_value() {
        return __get__(this, function (self, nested_list, index_keys, value) {
            if (arguments.length) {
                var __ilastarg0__ = arguments.length - 1;
                if (arguments[__ilastarg0__] && arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")) {
                    var __allkwargs0__ = arguments[__ilastarg0__--];
    ...
    get _index_path() {
        return __get__(this, function (self, index_keys, neighbor_keys) {
            if (arguments.length) {
                var __ilastarg0__ = arguments.length - 1;
                if (arguments[__ilastarg0__] && arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")) {
                    var __allkwargs0__ = arguments[__ilastarg0__--];
    ...
    get _swap_value() {
        return __get__(this, function (self, index_keys, val1, val2) {
            if (arguments.length) {
                var __ilastarg0__ = arguments.length - 1;
                if (arguments[__ilastarg0__] && arguments[__ilastarg0__].hasOwnProperty("__kwargtrans__")) {
                    var __allkwargs0__ = arguments[__ilastarg0__--];
                    for (var __attrib0__ in __allkwargs0__) {
                        switch (__attrib0__) {
                            ...
                            case 'index_keys':
                                ...
                                break;
                            case 'val1':
                                var val1 = __allkwargs0__[__attrib0__];
                                break;
                            case 'val2':
                                var val2 = __allkwargs0__[__attrib0__];
                                break;
                        }
                    }
                }
...
//# sourceMappingURL=tessagon.core.abstract_tile.js.map