...
export class InnerDesignHashmarks extends FastAbstractInnerDesign {
    makeDesign(paper, params) {
        const { boundaryModel, outerModel, bufferWidth, hashWidth, initialNoiseRange1, initialNoiseRange2, noiseOffset1, noiseOffset2, noiseInfluence } = params;
        ...
        var i = 0;
        while (pos <= width) {
            var newNoise1 = (this.simplex.noise2D(i / 200, i / 300) + noiseOffset1) * noiseInfluence;
            var newNoise2 = (this.simplex.noise2D(i / 20, i / 30) + noiseOffset2) * noiseInfluence;
            i += 1;
...
//# sourceMappingURL=hashmarks.js.map