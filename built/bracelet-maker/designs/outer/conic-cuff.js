...
export class ConicCuffOuter {
    constructor(subModel) {
        this.subModel = subModel;
        this.controlInfo = `Measure your wrist with a sewing measuring tape. I suggest measuring pretty tight, this pattern adds some length.<br/>
  Cis male wrists average around 7 inches, cis female wrists closer to 6.5 inches."`;
    }
    addRivetHoles(paper, height, cuffModel, cuffModelInner) {
        /***** START RIVET HOLES *****/
        const boltGuideLine1P1 = new paper.Point(cuffModel.shortRadius * Math.cos(cuffModelInner.widthOffset.radians / 2), cuffModel.shortRadius * Math.sin(cuffModelInner.widthOffset.radians / 2));
        const boltGuideLine1P2 = new paper.Point(cuffModel.longRadius * Math.cos(cuffModelInner.widthOffset.radians / 2), cuffModel.longRadius * Math.sin(cuffModelInner.widthOffset.radians / 2));
        const boltGuideLine2P1 = new paper.Point(cuffModel.longRadius *
            Math.cos(cuffModel.alpha.radians - cuffModelInner.widthOffset.radians / 2), cuffModel.longRadius *
            Math.sin(cuffModel.alpha.radians - cuffModelInner.widthOffset.radians / 2));
        const boltGuideLine2P2 = new paper.Point(cuffModel.shortRadius *
            Math.cos(cuffModel.alpha.radians - cuffModelInner.widthOffset.radians / 2), cuffModel.shortRadius *
            Math.sin(cuffModel.alpha.radians - cuffModelInner.widthOffset.radians / 2));
        ...
        const leftBolts = makeEvenlySpacedBolts(paper, numBolts, boltGuideLine1P1, boltGuideLine1P2);
        const rightBolts = makeEvenlySpacedBolts(paper, numBolts, boltGuideLine2P1, boltGuideLine2P2);
    ...
    make(paper, options) {
        ...
        cuffModelInner.model.translate(new paper.Point(-toTranslateX, -toTranslateY));
        ...
        cuffModelInner.model.translate(new paper.Point(-toTranslateX2, -toTranslateY2 + safeBorderWidth));
        /***** START DESIGN *****/
...
//# sourceMappingURL=conic-cuff.js.map